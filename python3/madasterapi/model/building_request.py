...
def lazy_import():
    ...
    globals()['BuildingPhase'] = BuildingPhase


class BuildingRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'last_renovation_date': (datetime, none_type,),  # noqa: E501
            ...
            'expected_lifespan': (int, none_type,),  # noqa: E501
    ...
    def __init__(self, folder_id, name, phase, completion_date, building_usage, gross_surface_area, classification_type, material_classification_type_id, *args, **kwargs):  # noqa: E501
        ...
        Args:
            folder_id (str): The identifier of the parent folder
        ...
        Keyword Args:
            ...
            last_renovation_date (datetime, none_type): The last renovation date of the building. [optional]  # noqa: E501
            ...
            expected_lifespan (int, none_type): The expected lifespan for the building. [optional]  # noqa: E501
