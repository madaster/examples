...
class MaterialRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, material_families, circular, *args, **kwargs):  # noqa: E501
        """MaterialRequest - a model defined in OpenAPI

        Args:
            name (MultiLingualString):
            material_families ([MaterialFamilyClassification], none_type): The material families (call /api/v3.0/system/materialfamilies, to retrieve possible values)
        ...
        self.name = name
        self.material_families = material_families
