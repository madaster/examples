...
class DatabaseType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The database type.., must be one of ["VerifiedDatabase", "Supplier", "General", ]  # noqa: E501

        Keyword Args:
            value (str): The database type.., must be one of ["VerifiedDatabase", "Supplier", "General", ]  # noqa: E501
