...
class ElementDimensionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ElementDimensionType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["Length", "Width", "Height", "Depth", "Diameter", "Radius", "Thickness", "Area", "Volume", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["Length", "Width", "Height", "Depth", "Diameter", "Radius", "Thickness", "Area", "Volume", ]  # noqa: E501
