...
def lazy_import():
    ...
    globals()['PriceUnit'] = PriceUnit


class MaterialFinancialValue(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, date, currency, unit, *args, **kwargs):  # noqa: E501
        """MaterialFinancialValue - a model defined in OpenAPI

        Args:
            value (float): The value of the material at this given moment
            date (datetime): The moment at which this value was taken
            currency (Currency):
            unit (PriceUnit):
        ...
        Keyword Args:
            ...
            id (str): The value identifier. [optional]  # noqa: E501
        """
