...
class AcceptLanguage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AcceptLanguage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The culture to use for the request. if omitted defaults to "en", must be one of ["en", "nl", "fr", "de", ]  # noqa: E501

        Keyword Args:
            value (str): The culture to use for the request. if omitted defaults to "en", must be one of ["en", "nl", "fr", "de", ]  # noqa: E501
