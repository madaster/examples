...
class MaterialFamilyClassification(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'classification_id': (str, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, classification_id, id, *args, **kwargs):  # noqa: E501
        """MaterialFamilyClassification - a model defined in OpenAPI

        Args:
            classification_id (str, none_type): The classification identifier
            id (str, none_type): The identifier
