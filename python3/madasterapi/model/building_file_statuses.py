...
class BuildingFileStatuses(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'IMPORTING': "Importing",
            'IMPORTED': "Imported",
            'UNKNOWNIMPORTFILE': "UnknownImportFile",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """BuildingFileStatuses - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The building file status enum.., must be one of ["Error", "Uploaded", "Refined", "Mapped", "Refining", "Mapping", "Creating", "Importing", "Imported", "UnknownImportFile", ]  # noqa: E501

        Keyword Args:
            value (str): The building file status enum.., must be one of ["Error", "Uploaded", "Refined", "Mapped", "Refining", "Mapping", "Creating", "Importing", "Imported", "UnknownImportFile", ]  # noqa: E501
