...
class FolderRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'foldertype_id': 'foldertypeId',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, parent_id, foldertype_id, *args, **kwargs):  # noqa: E501
        """FolderRequest - a model defined in OpenAPI

        Args:
            name (str, none_type): The folder name
            parent_id (str): The parent folder identifier (is a folderId or accountId)
            foldertype_id (str): The foldertype identifier
        ...
        Keyword Args:
            ...
            description (str, none_type): The folder description. [optional]  # noqa: E501
            owner (str, none_type): The owner, used in the passports. [optional]  # noqa: E501
        """
        ...
        self.foldertype_id = foldertype_id
