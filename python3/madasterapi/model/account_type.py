...
class AccountType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The account type.., must be one of ["VerifiedDatabase", "Supplier", "General", "Private", ]  # noqa: E501

        Keyword Args:
            value (str): The account type.., must be one of ["VerifiedDatabase", "Supplier", "General", "Private", ]  # noqa: E501
