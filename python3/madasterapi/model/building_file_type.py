...
class BuildingFileType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """BuildingFileType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The building file type enum.., must be one of ["Source", "Information", "PassportPdf", "PassportExcel", ]  # noqa: E501

        Keyword Args:
            value (str): The building file type enum.., must be one of ["Source", "Information", "PassportPdf", "PassportExcel", ]  # noqa: E501
