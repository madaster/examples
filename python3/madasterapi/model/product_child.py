...
def lazy_import():
    ...
    globals()['ProductChildCircularInformation'] = ProductChildCircularInformation


class ProductChild(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'id': (str,),  # noqa: E501
            'circular': (ProductChildCircularInformation,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, value, child_id, *args, **kwargs):  # noqa: E501
        """ProductChild - a model defined in OpenAPI

        Args:
            value (float): The value of this child relation, so how much of the child can be found in the parent product, with a unit depending on the relation type
            child_id (str): The product/material identifier of the child
        ...
        Keyword Args:
            ...
            id (str): The parent-child relationship identifier. [optional]  # noqa: E501
            circular (ProductChildCircularInformation): [optional]  # noqa: E501
        """
