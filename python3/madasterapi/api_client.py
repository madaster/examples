...
from madasterapi import rest
from madasterapi.configuration import Configuration
from madasterapi.exceptions import ApiTypeError, ApiValueError, ApiException
from madasterapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.account_get_account  # this is an instance of the class Endpoint
        api_instance.account_get_account()  # this invokes api_instance.account_get_account.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.account_get_account.callable or self.callable in this class
